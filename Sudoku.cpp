  ...
  for (int n=0;n<board.size();++n) {
	  for (int m=0;m<board.size();++m) {
		  if (board[n][m]!=0) {
			  ...
			  hash3[300*n+15*m-(m%d)*15-(n%d)*300+board[n][m]]=board[n][m];
}
}
}
fill(board,hash1,hash2,hash3,y,x,z);
...
{
int t;
//vector<vector<int>> A {{3,0,0,0,0,6,0,0,5},{0,0,9,0,5,8,0,0,0},{0,0,1,0,0,0,9,2,0},{0,0,0,0,0,0,2,0,0},
//	{7,4,0,0,0,0,3,0,6},{0,3,0,0,0,0,0,0,7},{9,0,0,0,1,3,6,7,0},{2,5,0,0,9,0,8,0,0},{0,0,0,0,0,0,0,4,0}};
